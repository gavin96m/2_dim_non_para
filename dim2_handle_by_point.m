...
function dim2_handle_by_point(filename,datafilename,regionsize,numpoint)
    ...
    for i = 1:rows
        for j = 1:cols
           ...
           for k = 1:num_points
            ...
            % After going through all the points in the source region, store the probabilities
            probability((j-1)*rows + i, :, :) = temp_probability; 
            % print progress
